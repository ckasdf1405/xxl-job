	    ...
	    "columns": [
					{
						...
						"mRender": function (settings, rowIdx, rec, type) {
							...
							if (isChecked == "1") {
								return "<label><input type='checkbox' name='checkBox1' value='" + date + "' checked='checked'/></label>";
							}

							return "<label><input type='checkbox' name='checkBox1' value='" + date + "'/></label>";;
						}
					},
	                {
	                	"data": 'id',
